...
export default {
  ...
  methods: {
    fetchCourseById(id) {
      courseApi.getCourseById(id).then((reponse) => {
        this.courseInfo = reponse.data;
        subjectApi.getSubjectList(0).then((response) => {
          ...
          this.subjectList.forEach((subject) => {
            ...
            if (subject.id === this.courseInfo.subjectParentId) {
              ...
              subjectApi.getSubjectList(subject.id).then((response) => {
    ...
    subjectChanged(value) {
      subjectApi.getSubjectList(value).then((response) => {
